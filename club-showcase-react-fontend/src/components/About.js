    ...
    return (
      <div className="about-container">
        ...
        <p className="about-p1">
          I am currently a student at the University of Maryland, College Park,
          studying Information Science (major), Computer Science (minor), and
          Techology Entreprenuership (minor).
        </p>
        <p className="about-p1">
          I built this app to simply learn and demonstrate my ReactJS {"&"} Redux
        ...
        <p className="about-p1">
          ...
          <a href={"https://www.youtube.com/watch?v=ti-VLxpexYI&t=127s"} target="_blank" rel="noreferrer">
